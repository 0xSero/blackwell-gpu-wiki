...
| --- | --- | --- | --- |
| 10.0 (SM100) | GB100, GB200, GB300 | B100, B200, B300, GB200/GB300 superchips, "RTX PRO 6000 Blackwell **Server Edition**" | SXM, PCIe |
| 12.0 (SM120) | GB202 | RTX PRO 6000 Blackwell **Workstation Edition**, RTX 5090, RTX 5080 | PCIe |

Note: the **same brand string** ("RTX PRO 6000 Blackwell") maps to two physically different cards. The disambiguation is in the suffix word ("Server" vs "Workstation"). On a spec sheet they look 90 % identical (96 GB memory, similar TDP, similar form factor) but the silicon underneath is different.
